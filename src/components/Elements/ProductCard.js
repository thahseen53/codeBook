    ...
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <div className="p-5">
            ...
            <p className="flex justify-between items-center">
                ...
                {!inCart && <button onClick={()=>addToCart(product)} className={`inline-flex items-center py-2 px-3 text-sm font-medium text-center  ${product.in_stock?"text-white bg-blue-700 rounded-lg hover:bg-blue-800":"cursor-not-allowed text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900"}`} disabled={product.in_stock? "" : "disabled"}>{product.in_stock?"Add To Cart ":'Out of stock'}<i className="ml-1 bi bi-plus-lg"></i></button>}
